...
export function Collapse({ collapsed, children, duration = 200, easing, onAnimationEnd, renderChildrenWhenCollapsed }: PropsWithChildren<CollapseProps>) {
    ...
    const styleOfOpacity = { opacity: renderChildrenWhenCollapsed || !collapsed ? 1 : 0 }

    return (
        <Animated.View style={[styles.container, { height: animatedHeight.current }]}>
            <View
                style={[styles.content, styleOfOpacity]}
                pointerEvents="none"
