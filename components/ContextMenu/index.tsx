import { PropsWithChildren, type Ref, useCallback, useImperativeHandle, useRef, useState } from "react"
import { Animated, Dimensions, type GestureResponderEvent, type LayoutChangeEvent, Modal, Pressable, StyleSheet } from "react-native"
...
export function ContextMenu({ children, ref }: PropsWithChildren<ContextMenuProps>) {
    ...
    const setPosition = useCallback((straightforwardMenuSize?: { width: number, height: number }) => {
    ...
    return (
        <Modal visible={visible} transparent>
            <Pressable style={styles.container} onPress={hide}>
                <Animated.View
                    style={[styles.contextWrapper, combinedStyle]}
